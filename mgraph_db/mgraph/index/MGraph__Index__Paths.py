...
class MGraph__Index__Paths(Type_Safe):
    index_data: Schema__MGraph__Index__Data   = None                                         # Shared index data reference (needs to be set via dependency injection)
